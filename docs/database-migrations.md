...
## Overview
This guide explains how to handle database migrations in Ledgerly using Room's migration features.
...
@Database(
    ...
    autoMigrations = [
        AutoMigration(
            from = 1, 
            to = 2, 
            spec = LedgerlyDatabase.Migration1To2::class
        )
    ]
)

// Inside LedgerlyDatabase
@RenameColumn(
