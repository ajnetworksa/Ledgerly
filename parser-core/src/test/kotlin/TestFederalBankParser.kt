...
import com.ledgerly.parser.core.test.ExpectedTransaction
import com.ledgerly.parser.core.test.ParserTestCase
import com.ledgerly.parser.core.test.ParserTestUtils
        ...
        val testCases = listOf(
            ...
            ParserTestCase(
                ...
                expected = ExpectedTransaction(
                    ...
                    currency = "INR",
                    type = com.ledgerly.parser.core.TransactionType.EXPENSE,
            ...
            ParserTestCase(
                ...
                expected = ExpectedTransaction(
                    ...
                    currency = "INR",
                    type = com.ledgerly.parser.core.TransactionType.INCOME,
            ...
            ParserTestCase(
                ...
                expected = ExpectedTransaction(
                    ...
                    currency = "INR",
                    type = com.ledgerly.parser.core.TransactionType.CREDIT,
                    merchant = "AMAZON",
                    accountLast4 = "5678",
            ...
            ParserTestCase(
                ...
                expected = ExpectedTransaction(
                    ...
                    currency = "INR",
                    type = com.ledgerly.parser.core.TransactionType.BALANCE_UPDATE,
