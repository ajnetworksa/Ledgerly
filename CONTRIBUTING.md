...
Thank you for your interest in contributing to Ledgerly! We welcome contributions from the community.

## How to Contribute

### 🐛 Reporting Bugs

1. Check if the bug has already been reported in [Issues](https://github.com/Mukto/ledgerly-tracker/issues)
...
1. Check [existing issues](https://github.com/Mukto/ledgerly-tracker/issues) for similar suggestions
...
1. Create a new parser class in `/app/src/main/java/com/ledgerly/tracker/data/parser/bank/`
...
```
app/
├── src/main/java/com/ledgerly/tracker/
│   ├── data/
...
- Follow development updates on [GitHub](https://github.com/Mukto/ledgerly-tracker)
...
Thank you for helping make Ledgerly better! 🚀
