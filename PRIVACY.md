...
Ledgerly is built with privacy as the core principle. We believe your financial data should remain yours alone.
...
- Data is only accessible to Ledgerly app
...
Ledgerly is fully open source:
- Review our code at [GitHub](https://github.com/Mukto/ledgerly-tracker)
- Verify our privacy claims yourself
- Contribute to make it even better

## Children's Privacy

Ledgerly is not directed at children under 13. We do not knowingly collect information from children.
...
- Open an issue on [GitHub](https://github.com/Mukto/ledgerly-tracker/issues)
...
*Ledgerly - Privacy-first expense tracking with on-device AI*