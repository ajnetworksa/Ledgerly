...
object ParseViews {
    suspend fun ApplicationCall.respondParsePage() {
        respondHtml(HttpStatusCode.OK) {
            head {
                title { +"Ledgerly - SMS Parser Tool" }
                meta { charset = "utf-8" }
                ...
                div(classes = "header") {
                    div(classes = "header-content") {
                        div(classes = "logo-section") {
                            a(href = "/") {
                                img(src = "/static/logo.png", alt = "Ledgerly", classes = "logo")
                                span(classes = "logo-text") { +"Ledgerly" }
                            }
                        }
                        nav(classes = "nav-links") {
                            ...
                            a(href = "https://github.com/Mukto/ledgerly-tracker", target = "_blank") {
                                unsafe {
