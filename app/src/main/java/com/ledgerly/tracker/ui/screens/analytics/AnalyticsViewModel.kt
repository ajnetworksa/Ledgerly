package com.ledgerly.tracker.ui.screens.analytics

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.ledgerly.tracker.data.currency.CurrencyConversionService
import com.ledgerly.tracker.data.database.entity.TransactionWithSplits
...
import com.ledgerly.tracker.presentation.common.TimePeriod
import com.ledgerly.tracker.presentation.common.TransactionTypeFilter
import com.ledgerly.tracker.presentation.common.getDateRangeForPeriod
import com.ledgerly.tracker.utils.CurrencyUtils
...
import com.ledgerly.tracker.ui.components.BalancePoint
...
class AnalyticsViewModel @Inject constructor(
        ...
        if (dateRange == null) {
            ...
            transactionRepository.getTransactionsBetweenDates(
                ...
                val dbTransactionType = when (filterState.typeFilter) {
                    ...
                    TransactionTypeFilter.INCOME -> com.ledgerly.tracker.data.database.entity.TransactionType.INCOME
                    TransactionTypeFilter.EXPENSE -> com.ledgerly.tracker.data.database.entity.TransactionType.EXPENSE
                    TransactionTypeFilter.CREDIT -> com.ledgerly.tracker.data.database.entity.TransactionType.CREDIT
                    TransactionTypeFilter.TRANSFER -> com.ledgerly.tracker.data.database.entity.TransactionType.TRANSFER
                    TransactionTypeFilter.INVESTMENT -> com.ledgerly.tracker.data.database.entity.TransactionType.INVESTMENT
                }
    ...
    private fun calculateSpendingTrend(
        transactions: List<com.ledgerly.tracker.data.database.entity.TransactionEntity>,
        startDate: LocalDate,
        endDate: LocalDate
    ): List<BalancePoint> {
