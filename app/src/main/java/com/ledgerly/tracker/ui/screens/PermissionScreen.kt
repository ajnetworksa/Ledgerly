package com.ledgerly.tracker.ui.screens
...
import com.ledgerly.tracker.ui.components.LedgerlyScaffold
import com.ledgerly.tracker.ui.theme.Spacing
import com.ledgerly.tracker.ui.viewmodel.PermissionViewModel
...
fun PermissionScreen(
    ...
    LedgerlyScaffold(
        ...
        Column(
            ...
            Text(
                text = "Ledgerly can automatically detect and categorize your bank transactions from SMS messages, saving you time and effort.",
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(Spacing.md)) {
                    ...
                    Text(
                        text = "Allow Ledgerly to read transaction notifications from supported banking apps. This helps capture purchases when SMS is delayed or unavailable.",
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                    Spacer(modifier = Modifier.height(Spacing.sm))
