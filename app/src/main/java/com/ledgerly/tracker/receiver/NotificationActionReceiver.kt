...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_DELETE_TRANSACTION = "com.ledgerly.tracker.ACTION_DELETE_TRANSACTION"
        const val ACTION_CONFIRM_TRANSACTION = "com.ledgerly.tracker.ACTION_CONFIRM_TRANSACTION"
        const val ACTION_CHANGE_CATEGORY = "com.ledgerly.tracker.ACTION_CHANGE_CATEGORY"
    ...
    private fun deleteTransaction(context: Context, transactionId: Long, notificationId: Int) {
        receiverScope.launch {
            try {
                val database = LedgerlyDatabase.getInstance(context)
