package com.ledgerly.tracker.receiver
...
import com.ledgerly.tracker.MainActivity
import com.ledgerly.tracker.LedgerlyApplication
import com.ledgerly.tracker.R
import com.ledgerly.tracker.data.manager.SmsTransactionProcessor
...
class SmsBroadcastReceiver : BroadcastReceiver() {
    ...
    interface SmsBroadcastReceiverEntryPoint {
        ...
        fun transactionRepository(): com.ledgerly.tracker.data.repository.TransactionRepository
    }

    companion object {
        private const val TAG = "SmsBroadcastReceiver"
        const val ACTION_EDIT_TRANSACTION = "com.ledgerly.tracker.ACTION_EDIT_TRANSACTION"
            ...
            try {
                ...
                if (result.success && result.transactionId != null) {
                    ...
                    if (!isAppInForeground(context)) {
                        ...
                        val parser = com.ledgerly.parser.core.bank.BankParserFactory.getParser(sender)
    ...
    private fun isAppInForeground(context: Context): Boolean {
        return try {
            val application = context.applicationContext as? LedgerlyApplication
    ...
    private fun showTransactionNotification(
        ...
        bankName: String,
        category: String,
        repository: com.ledgerly.tracker.data.repository.TransactionRepository
    ) {
        receiverScope.launch {
            try {
