package com.ledgerly.tracker.worker
...
import com.ledgerly.parser.core.bank.*
...
import com.ledgerly.tracker.data.repository.*
import com.ledgerly.tracker.domain.model.rule.TransactionRule
    ...
    private suspend fun runPipeline(
        ...
        val saver = launch(Dispatchers.IO) {
            ...
            if (widgetNeedsUpdate)
                com.ledgerly.tracker.widget.RecentTransactionsWidgetUpdateWorker.enqueueOneShot(applicationContext)
        }
...
// ─── Balance update ───────────────────────────────────────────────────────
    ...
    private suspend fun processBalanceUpdate(
        ...
        entity: com.ledgerly.tracker.data.database.entity.TransactionEntity,
        rowId: Long
    ) {
