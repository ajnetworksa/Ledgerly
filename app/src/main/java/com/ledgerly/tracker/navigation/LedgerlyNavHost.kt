package com.ledgerly.tracker.navigation
...
import com.ledgerly.tracker.ui.LocalNavAnimatedVisibilityScope
import com.ledgerly.tracker.ui.LocalSharedTransitionScope
import com.ledgerly.tracker.ui.MainScreen
...
fun LedgerlyNavHost(
    ...
    NavHost(
        ...
        composable<AppLock>(
            ...
            com.ledgerly.tracker.ui.screens.AppLockScreen(
                onUnlocked = {
        ...
        composable<OnBoarding>(
            ...
            com.ledgerly.tracker.ui.screens.onboarding.OnBoardingScreen(
        ...
        composable<Settings>(
            ...
            com.ledgerly.tracker.ui.screens.settings.SettingsScreen(
        ...
        composable<TransactionDetail>(
            ...
            CompositionLocalProvider(LocalNavAnimatedVisibilityScope provides this@composable) {
                com.ledgerly.tracker.presentation.transactions.TransactionDetailScreen(
        ...
        composable<AddTransaction>(
            ...
            com.ledgerly.tracker.presentation.add.AddScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                }
            )
        ...
        composable<Rules>(
            ...
            com.ledgerly.tracker.ui.screens.rules.RulesScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
        ...
        composable<CreateRule>(
            ...
            val rulesViewModel: com.ledgerly.tracker.ui.viewmodel.RulesViewModel = hiltViewModel()
            ...
            com.ledgerly.tracker.ui.screens.rules.CreateRuleScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
                onSaveRule = { rule ->
        ...
        composable<AccountDetail>(
            ...
            com.ledgerly.tracker.presentation.accounts.AccountDetailScreen(
        ...
        composable<BudgetGroups>(
            ...
            com.ledgerly.tracker.presentation.budgetgroups.BudgetGroupsScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
        ...
        composable<BudgetGroupEdit>(
            ...
            com.ledgerly.tracker.presentation.budgetgroups.BudgetGroupEditScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                }
            )
        ...
        composable<Loans>(
            ...
            com.ledgerly.tracker.presentation.loans.LoansScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
                onNavigateToLoanDetail = { loanId ->
        ...
        composable<LoanDetail>(
            ...
            com.ledgerly.tracker.presentation.loans.LoanDetailScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
        ...
        composable<TransactionGroups>(
            ...
            com.ledgerly.tracker.presentation.groups.TransactionGroupsScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
        ...
        composable<TransactionGroupDetail>(
            ...
            com.ledgerly.tracker.presentation.groups.TransactionGroupDetailScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                },
                onNavigateToTransactionDetail = { txId ->
        ...
        composable<ExchangeRates>(
            ...
            com.ledgerly.tracker.presentation.exchangerates.ExchangeRatesScreen(
                onNavigateBack = {
                    navController.safePopBackStack()
                }
            )
        ...
        composable<TransactionsWithFilter>(
            ...
            com.ledgerly.tracker.presentation.transactions.TransactionsScreen(
