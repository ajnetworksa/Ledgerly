package com.ledgerly.tracker.data.database
...
import com.ledgerly.tracker.data.database.converter.Converters
...
import com.ledgerly.tracker.data.database.entity.BankNotificationEntity
import com.ledgerly.tracker.data.database.entity.BudgetCategoryEntity
import com.ledgerly.tracker.data.database.entity.BudgetCategoryMonthSnapshotEntity
import com.ledgerly.tracker.data.database.entity.BudgetEntity
import com.ledgerly.tracker.data.database.entity.BudgetMonthSnapshotEntity
import com.ledgerly.tracker.data.database.entity.CardEntity
import com.ledgerly.tracker.data.database.entity.CategoryEntity
import com.ledgerly.tracker.data.database.entity.ChatMessage
import com.ledgerly.tracker.data.database.entity.ExchangeRateEntity
import com.ledgerly.tracker.data.database.entity.LoanEntity
import com.ledgerly.tracker.data.database.entity.MerchantMappingEntity
import com.ledgerly.tracker.data.database.entity.TransactionGroupEntity
import com.ledgerly.tracker.data.database.entity.RuleApplicationEntity
import com.ledgerly.tracker.data.database.entity.RuleEntity
...
abstract class LedgerlyDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         */
        fun getInstance(context: android.content.Context): LedgerlyDatabase {
         ...
         */
        fun setInstance(database: LedgerlyDatabase) {
            INSTANCE = database
        }
