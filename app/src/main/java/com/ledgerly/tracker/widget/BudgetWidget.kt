...
class BudgetWidget : GlanceAppWidget() {
    ...
    private fun BudgetOverviewContent(data: BudgetWidgetData) {
        ...
        val statusColor = LedgerlyWidgetTheme.budgetStatusColor(data.percentageUsed)
        ...
        if (!isSmall) {
            ...
            Row(
                ...
                if (data.totalIncome > BigDecimal.ZERO) {
                    ...
                    val savingsColor = LedgerlyWidgetTheme.savingsColor(data.netSavings >= BigDecimal.ZERO)
