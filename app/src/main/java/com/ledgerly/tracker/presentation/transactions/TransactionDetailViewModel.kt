package com.ledgerly.tracker.presentation.transactions
...
import com.ledgerly.tracker.data.database.entity.BudgetImpactType
...
import com.ledgerly.tracker.data.database.entity.LoanDirection
...
import com.ledgerly.tracker.ui.components.SplitItem
import com.ledgerly.tracker.data.receipt.ReceiptManager
...
import com.ledgerly.tracker.data.repository.MerchantMappingRepository
...
class TransactionDetailViewModel @Inject constructor(
    ...
    private suspend fun determinePrimaryCurrency(transaction: TransactionEntity) {
        ...
        val primaryCurrency = if (isUnified) {
            ...
            if (!bankName.isNullOrEmpty()) {
                com.ledgerly.tracker.utils.CurrencyFormatter.getBankBaseCurrency(bankName)
            } else {
    ...
    fun getReportUrl(): String {
        ...
        val encryptedDeviceData = com.ledgerly.tracker.utils.DeviceEncryption.encryptDeviceData(context)
