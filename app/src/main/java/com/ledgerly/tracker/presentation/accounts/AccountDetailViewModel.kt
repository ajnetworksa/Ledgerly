...
import com.ledgerly.tracker.data.currency.CurrencyConversionService.TransactionData
...
class AccountDetailViewModel @Inject constructor(
            ...
            combine(
                ...
                filteredTransactions.forEach { transaction ->
                    ...
                    when (transaction.transactionType) {
                        com.ledgerly.tracker.data.database.entity.TransactionType.INCOME -> totalIncome += convertedAmount
                        com.ledgerly.tracker.data.database.entity.TransactionType.EXPENSE -> totalExpenses += convertedAmount
    ...
    private fun computeBilledUnbilled(
        ...
        val creditTxs = allTransactions.filter {
            it.transactionType == com.ledgerly.tracker.data.database.entity.TransactionType.CREDIT
        }
